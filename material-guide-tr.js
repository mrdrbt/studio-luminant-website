...
const specMeta = {
  ...
  antimicrobial: {
    label: "Antimikrobiyal",
    unit: ""
  },
  method: {
    label: "Montaj yöntemi",
    unit: ""
  },
  speed: {
    label: "Montaj hızı",
...
const finishTypes = [{
  id: "matte",
  label: "Mat",
  desc: "Pürüzsüz, yansımasız yüzey",
  preview: {
  ...
  id: "satin",
  label: "Saten",
  desc: "Yumuşak parlaklık, düşük yansıma",
  preview: {
  ...
  id: "metal",
  label: "Gerçek Metal Varak",
  desc: "Gerçek metal varak uygulaması",
  preview: {
...
const radarAxes = [{
  ...
  key: "finishQuality",
  label: "İşlem Kalitesi"
}, {
  key: "designFreedom",
  label: "Tasarım Özgürlüğü"
}, {
  key: "installSpeed",
  label: "Montaj Hızı"
}, {
...
function FinishColorSelector({
  ...
  }, "Yüzey İşlemi"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 6,
      flexWrap: "wrap",
...
function MaterialCard({
  ...
  }, isExpanded ? "Daralt" : "Keşfet")), isExpanded && /*#__PURE__*/React.createElement("div", {
    style: {
...
function MaterialGuide() {
  ...
  }, "Malzeme Zekâsı"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: "'Cormorant Garamond',serif",
  ...
  }, compareMode ? "Karşılaştırmayı Kapat" : "Endüstri Standartlarıyla Karşılaştır")), compareMode && /*#__PURE__*/React.createElement("div", {
    style: {
      background: COLORS.surface,
      border: `1px solid ${COLORS.borderGold}`,
      borderRadius: 2,
  ...
  }, "Karşılaştırılan:"), studioMaterials.map(m => /*#__PURE__*/React.createElement("button", {
    key: m.id,
